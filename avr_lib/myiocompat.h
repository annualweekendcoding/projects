 ...
 * Erweitert von Mirko Wittek 10.12.2009 
 */

#if !defined(MYIOCOMPAT_H)
#define MYIOCOMPAT_H 1
...
#  define TIMER1_CLOCKSOURCE1  _BV(CS10)             /* don´t use prescaler */
#  define TIMER1_CLOCKSOURCE2  _BV(CS11)             /* use 1/2 prescaler */
#  define TIMER1_CLOCKSOURCE4  _BV(CS10) | _BV(CS11) /* use 1/4 prescaler */
#  define TIMER1_CLOCKSOURCE8  _BV(CS12)             /* use 1/8 prescaler */
#  define TIMER1_CLOCKSOURCE16 _BV(CS10) | _BV(CS12) /* use 1/16 prescaler */
...
#if !defined(TIMER1_CLOCKSOURCE8)
#  define TIMER1_CLOCKSOURCE1 _BV(CS10) /* full clock */
#endif

#endif /* !defined(MYIOCOMPAT_H) */
