...
#include <net_config.h>
    ...
    //IP des MAIL-Servers 
    #ifndef MAIL_SERVER
    #error MAIL_SERVER ist nicht definiert
    #endif    
    ...
    #define SMTP_USERNAME "\0"
    #endif
    
    #ifndef SMTP_PASSWORD
    #define SMTP_PASSWORD "\0"
    #endif
    
    //SMTP_MAIL Sender
    #ifndef MAIL_FROM
    #error MAIL_FROM nicht definiert
    #endif
    //#define MAIL_FROM "mail@ulrichradig.de" 
    
    //SMTP_MAIL Empfänger
    #ifndef MAIL_TO
    #error MAIL_TO nicht definiert
    #endif
