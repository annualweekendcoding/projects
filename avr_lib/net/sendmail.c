...
PROGMEM char SMTP_MAIL[] = "MAIL FROM:<" MAIL_FROM ">\r\n";
PROGMEM char SMTP_RCPT[] = "RCPT TO:<" MAIL_TO ">\r\n";
PROGMEM char SMTP_DATA[] = "DATA\r\n";
PROGMEM char SMTP_TEXT[] = "Envelope-To: <" MAIL_TO ">\r\nFrom: <" MAIL_FROM">\r\nSubject:" MAIL_SUBJECT "\r\n\r\n" MAIL_TEXT;
...
unsigned char mail_send (void)
{
	if(mail_get == 0) //Falls nicht derzeit bereits eine Mail gesendet wird
	{
		...
		unsigned int my_mail_cp_new = my_mail_cp + time_ms;
